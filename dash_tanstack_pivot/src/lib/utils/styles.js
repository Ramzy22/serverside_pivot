export const themes = {
    ...
    strata: {
        ...
        headerSubtleBg: 'rgba(20,20,28,0.98)',
    ...
    crystal: {
        ...
        headerSubtleBg: 'rgba(8,14,26,0.95)',
        sortedHeaderBg: 'rgba(0,242,255,0.08)',
        sortedHeaderBorder: '#00f2ff',
        sortedHeaderText: '#00f2ff',
        text: '#f9fafb',
        ...
        hoverStrong: 'rgba(255,255,255,0.05)',
        ...
        shadowMd: '0 18px 40px rgba(0,0,0,0.50), 0 2px 10px rgba(0,0,0,0.30)',
    ...
    alabaster: {
        ...
        hoverStrong: 'rgba(37,99,235,0.07)',
        ...
        shadowMd: '0 8px 20px rgba(0,0,0,0.06), 0 2px 6px rgba(0,0,0,0.04)',
        shadowInset: 'inset 0 1px 0 rgba(255,255,255,0.9)',
    },
    satin: {
        name: 'satin',
        primary: '#0f172a',
        ...
        shadowMd: '0 8px 20px rgba(0,0,0,0.05), 0 2px 6px rgba(0,0,0,0.03)',
        shadowInset: 'inset 0 1px 0 rgba(255,255,255,0.9)',
    }
};
...
export const getStyles = (theme) => {
    ...
    root: {
        ...
        fontFamily: "var(--sp-font-sans, 'Inter', ui-sans-serif, system-ui, sans-serif)",
        height: '100%',
...
export function injectThemeCssVars(theme, containerEl = document.documentElement) {
    ...
    const vars = {
        ...
        '--sp-font-sans':          "'Inter', ui-sans-serif, system-ui, sans-serif",
